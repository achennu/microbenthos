...
import os
from microbenthos import validate_dict, get_schema, yaml
...
model_dict = validate_dict(mdict, key='model') # uses inbuilt schema

# model_dict = validate_yaml(model_path, open(schema_path))
