...
# -*- coding: utf-8 -*-
#
# microbenthos documentation build configuration file, created by
...
project = u'MicroBenthos'
copyright = u"2018, Arjun Chennu"
...
version = microbenthos.__version__
# The full version, including alpha/beta/rc tags.
release = microbenthos.__version__
...
htmlhelp_basename = 'microbenthosdoc'

# Example configuration for intersphinx: refer to the Python standard library.
intersphinx_mapping = {
    'python': ('https://docs.python.org/2.7', None),
    'logutils': ('https://pythonhosted.org/logutils/', None),
...
# [howto/manual]).
latex_documents = [
    ('index', 'microbenthos.tex',
     u'MicroBenthos Documentation',
     u'Arjun Chennu', 'manual'),
    ]
